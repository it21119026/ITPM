...
export default class CreateDonee extends Component {
    constructor(props) {
        super(props);
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/Donee/add', Donee)
    ...
    render() {
        return ( <div ><Navbar/>
            ...
            <div class = "col-6" >
            <br/>
            <img src={`/Province/${this.state.State}.png`}  width="80%" height="70%"  />
            ...
            <font face = "Comic sans MS" size = "6" > Request Donate To {`${this.state.State}`} </font>
            </h3 > <br></br>
