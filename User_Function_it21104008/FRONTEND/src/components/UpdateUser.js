...
export default function UpdateUser() {
    ...
    function sendData(e) {
        ...
        axios.put(`http://localhost:8070/users/update/${id}`, newUser).then(() => {
            alert("User Updated");
           ...
           <br /><br />
            <div class="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <div class="flex items-center justify-between mb-4">
                    <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white"><center>Edit Donee Details</center> </h5>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                                        <input type="text" id="user_name" value={ user_id} onChange={(e) => {
                        ...
                        <li class="pt-3 pb-0 sm:pt-4">
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                                        <input type="text" id="school" value={school} onChange={(e) => {
