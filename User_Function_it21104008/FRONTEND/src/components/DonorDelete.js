...
export default function DeleteDonor() {
    ...
    const { id } = useParams();
    useEffect(() => {
        axios.get(`http://localhost:8070/donor/get/${id}`).then((res) => {
    ...
    function sendData(e) {
        ...
        axios.delete(`http://localhost:8070/donor/delete/${id}`).then(() => {
            alert("User Deleted");
        ...
        <center>   
            ...
            <div class="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <div class="flex items-center justify-between mb-4">
                    <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white"><center>Delete Donor Details</center> </h5>
