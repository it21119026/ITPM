                            ...
                            <form className="form" onSubmit={sendData}>
                                ...
                                <div className="relative z-0 w-full mb-6 group">
                                    ...
                                    <input className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                        placeholder='Enter Number' type="text" id=" user_id" value={user_id} onChange={(e) => {
                                ...
                                <div className="relative z-0 w-full mb-6 group">
                                    ...
                                    <input className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  placeholder='Enter Name' type="text" id="user_name" value={user_name} onChange={(e) => {
                                ...
                                <div className="relative z-0 w-full mb-6 group">
                                    ...
                                    <input className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder='Enter NIC Number' type="text" id="nic_number" value={nic_number} onChange={(e) => {
                                        setNic_number(e.target.value);
                                    }} required /></div>


                                <div className="relative z-0 w-full mb-6 group">
                                    <label for="school" className="">School</label>


                                    <input className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  placeholder='Enter School' type="school" id="school" value={school} onChange={(e) => {
